...
def get_ip_data():
    ...
    input_brand =input("What is the brand of this device?")
    input_location = input("What is the location of this ipadress?")
    d = {"IP": input_ip, "driver": input_driver,"brand":input_brand, "location":input_location}
    return d
